...
//private static Logger logger = Logger.getLogger(HttpRequestUtil.class);
     ...
     * @throws IOException
     */
    private static HttpsURLConnection getConnection(String method, URL url) throws IOException {
     ...
     */
    private static WeiXinResult ContentType(String contentType, HttpsURLConnection conn, String savePath) {
        WeiXinResult result = new WeiXinResult();
        try {
            if (conn != null) {
                InputStream input = conn.getInputStream();
